...
*
* \note You should later free the Tensor with tc_free_tensor.
*
...
* \return Pointer to a Tensor.
*
* \note You should later free the Tensor with tc_free_tensor_w_shared_shape.
* And the initial Tensor with tc_free_tensor.
*
...
*
* \note Generating a Tensor using this function will be substantially slower

...
/** \var char *test_running
* \brief Global set to the name of the test that's running.
*
* You can use it to print the name of a test that failed.
*/
extern char *test_running;
#endif
